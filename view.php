...
<div>
    <div class="row-sm-12">
        ...
        <div style="position: fixed" class="col-sm-3">
            <?php
            ...
            <div align="center">
                ...
                <img style="padding-top:10px;" src="<?php echo "images/".$getphoto[2]; ?>" class="img-circle" alt="Cinque Terre" width="220" height="270">
        ...
        <div class="col-sm-9" style="float:right">
            ...
            <div class="div1">
                ...
                <div class="school">
                    ...
                    <span style="margin-left:13px;">BE-CSE</span><br />
